...
String myScript = "/macros/s/xxxxxxxxxxxxxxxxxxxx/exec";    //Create your Google Apps Script and replace the "myScript" path.
String dbHost = "xxx.xxx.xxx.xxx";
int dbPort = 3306;
String dbUser = "xxxxx";
String dbPassword = "xxxxx";
String databaseName = "xxxxx";
String tableName = "xxxxx";
String columnName = "xxxxx";  //Data Type : TEXT
...
void SaveCapaturedPhoto2mySQL() {
  ...
  if (client.connect(myDomain, 443)) {
    ...
    String Data = "dbHost="+dbHost+"&dbPort="+String(dbPort)+"&dbUser="+dbUser+"&dbPassword="+dbPassword+"&databaseName="+databaseName+"&tableName="+tableName+"&columnName="+columnName+"&myFile=";
    
    esp_camera_fb_return(fb);
    
    Serial.println("Save a captured image to MySQL.");
