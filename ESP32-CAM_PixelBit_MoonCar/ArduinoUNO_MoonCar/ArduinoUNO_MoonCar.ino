...
void executeCommand() {
  if (cmd=="yourcmd") {
      ...
      if (P1=="S") {
        ...
        analogWrite(pingL1,speedL*turnRatio);
        analogWrite(pingL2,0);
        analogWrite(pingR1,0);
        analogWrite(pingR2,speedR);          
      }
        ...
        analogWrite(pingL1,0);
        analogWrite(pingL2,speedL*turnRatio);
        analogWrite(pingR1,speedR);
        analogWrite(pingR2,0);     
      }
      else if  (P1=="FR") {
        ...
        analogWrite(pingL2,0);
        analogWrite(pingR1,0);
        analogWrite(pingR2,speedR*turnRatio);          
      }
      else if  (P1=="RA") {
        analogWrite(pingL1,0);
        analogWrite(pingL2,speedL);
        analogWrite(pingR1,speedR*turnRatio);
        analogWrite(pingR2,0);     
      }     
    }
    else if (cmd=="speedL") {
    ...
    else if (cmd=="turnRatio") {
      turnRatio = P1.toFloat();
    }    
}
