...
Author : ChungYi Fu (Kaohsiung, Taiwan)  2020-1-5 13:00
...
int angle=4850;              //Angle of Servo position (1700~8000)
int degree=210;              //Degrees in angle of rotation
int rotationInterval=1000;  //Rotation interval (ms)
