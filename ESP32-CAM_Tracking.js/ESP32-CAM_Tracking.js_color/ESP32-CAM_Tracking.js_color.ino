...
Author : ChungYi Fu (Kaohsiung, Taiwan)  2020-11-15 00:00
...
static const char PROGMEM INDEX_HTML[] = R"rawliteral(<!doctype html>
  <!DOCTYPE html>
    ...
    <body>
            ...
            <section id="buttons">
                <table>
                <tr><td><button id="restart" onclick="try{fetch(document.location.origin+'/control?restart');}catch(e){}">Restart</button></td><td><button id="get-still">Get Still</button></td><td><button id="toggle-stream" style="display:none"></button><input type="checkbox" id="showpix" value="Show Pixel" onclick="if (this.checked) canvas_custom.style.display='block'; else canvas_custom.style.display='none';">Show Pixel</td></tr>
                </table>
            </section>
            ...
            <table style="border:0px;width:350px">
              ...
              <tr>
                ...
                <div id="divColor1">
                  ...
                  <tr>
                    <td align="center" width="20%">R</td>
                    <td colspan="2">min<input type="range" id="myColor_r_min1" min="0" max="255" value="0" step="1" style="width:200px" onchange="myColor_r_min_v1.innerHTML=this.value;"><span id="myColor_r_min_v1">0</span><br>
                      max<input type="range" id="myColor_r_max1" min="0" max="255" value="0" step="1" style="width:200px" onchange="myColor_r_max_v1.innerHTML=this.value;"><span id="myColor_r_max_v1">0</span>
                    </td>
                  </tr>
                  <tr>
                    <td align="center" width="20%">G</td>
                    <td colspan="2">min<input type="range" id="myColor_g_min1" min="0" max="255" value="0" step="1" style="width:200px" onchange="myColor_g_min_v1.innerHTML=this.value;"><span id="myColor_g_min_v1">0</span><br>
                      max<input type="range" id="myColor_g_max1" min="0" max="255" value="0" step="1" style="width:200px" onchange="myColor_g_max_v1.innerHTML=this.value;"><span id="myColor_g_max_v1">0</span>
                    </td>
                  </tr>
                  <tr>
                    <td align="center" width="20%">B</td>
                    <td colspan="2">min<input type="range" id="myColor_b_min1" min="0" max="255" value="0" step="1" style="width:200px" onchange="myColor_b_min_v1.innerHTML=this.value;"><span id="myColor_b_min_v1">0</span><br>
                      max<input type="range" id="myColor_b_max1" min="0" max="255" value="0" step="1" style="width:200px" onchange="myColor_b_max_v1.innerHTML=this.value;"><span id="myColor_b_max_v1">0</span>
                    </td>
                  </tr>
                  </table>
                </div>
                <div id="divColor2" style="display:none">
                  ...
                  <tr>
                    <td align="center" width="20%">R</td>
                    <td colspan="2">min<input type="range" id="myColor_r_min2" min="0" max="255" value="0" step="1" style="width:200px" onchange="myColor_r_min_v2.innerHTML=this.value;"><span id="myColor_r_min_v2">0</span><br>
                      max<input type="range" id="myColor_r_max2" min="0" max="255" value="0" step="1" style="width:200px" onchange="myColor_r_max_v2.innerHTML=this.value;"><span id="myColor_r_max_v2">0</span>
                    </td>
                  </tr>
                  <tr>
                    <td align="center" width="20%">G</td>
                    <td colspan="2">min<input type="range" id="myColor_g_min2" min="0" max="255" value="0" step="1" style="width:200px" onchange="myColor_g_min_v2.innerHTML=this.value;"><span id="myColor_g_min_v2">0</span><br>
                      max<input type="range" id="myColor_g_max2" min="0" max="255" value="0" step="1" style="width:200px" onchange="myColor_g_max_v2.innerHTML=this.value;"><span id="myColor_g_max_v2">0</span>
                    </td>
                  </tr>
                  <tr>
                    <td align="center" width="20%">B</td>
                    <td colspan="2">min<input type="range" id="myColor_b_min2" min="0" max="255" value="0" step="1" style="width:200px" onchange="myColor_b_min_v2.innerHTML=this.value;"><span id="myColor_b_min_v2">0</span><br>
                      max<input type="range" id="myColor_b_max2" min="0" max="255" value="0" step="1" style="width:200px" onchange="myColor_b_max_v2.innerHTML=this.value;"><span id="myColor_b_max_v2">0</span>
                    </td>
                  </tr>
                  </table>
                </div>
                <div id="divColor3" style="display:none">
                  ...
                  <tr>
                    <td align="center" width="20%">R</td>
                    <td colspan="2">min<input type="range" id="myColor_r_min3" min="0" max="255" value="0" step="1" style="width:200px" onchange="myColor_r_min_v3.innerHTML=this.value;"><span id="myColor_r_min_v3">0</span><br>
                      max<input type="range" id="myColor_r_max3" min="0" max="255" value="0" step="1" style="width:200px" onchange="myColor_r_max_v3.innerHTML=this.value;"><span id="myColor_r_max_v3">0</span>
                    </td>
                  </tr>
                  <tr>
                    <td align="center" width="20%">G</td>
                    <td colspan="2">min<input type="range" id="myColor_g_min3" min="0" max="255" value="0" step="1" style="width:200px" onchange="myColor_g_min_v3.innerHTML=this.value;"><span id="myColor_g_min_v3">0</span><br>
                      max<input type="range" id="myColor_g_max3" min="0" max="255" value="0" step="1" style="width:200px" onchange="myColor_g_max_v3.innerHTML=this.value;"><span id="myColor_g_max_v3">0</span>
                    </td>
                  </tr>
                  <tr>
                    <td align="center" width="20%">B</td>
                    <td colspan="2">min<input type="range" id="myColor_b_min3" min="0" max="255" value="0" step="1" style="width:200px" onchange="myColor_b_min_v3.innerHTML=this.value;"><span id="myColor_b_min_v3">0</span><br>
                      max<input type="range" id="myColor_b_max3" min="0" max="255" value="0" step="1" style="width:200px" onchange="myColor_b_max_v3.innerHTML=this.value;"><span id="myColor_b_max_v3">0</span>
                    </td>
                  </tr>
                  </table>
                </div>
  ...
  <script>
    ...
    window.onload = function() {getStill.click();}
  </script>   
)rawliteral";
