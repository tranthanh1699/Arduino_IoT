...
String sheetid = "1v9i275rzYC1wqoeNY_2XgT6JoUuv0_DtPdSCtzfqRq8"; //Google Spreadsheet ID
...
String getSpreadsheetJson(String range) {
  const char* myDomain = "spreadsheets.google.com";
  ...
  {
    getBody="Connected to spreadsheets.google.com failed.";
    Serial.println("Connected to spreadsheets.google.com failed.");
  }
  return getBody;
}
