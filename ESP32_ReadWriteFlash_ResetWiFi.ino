/* 
NodeMCU (ESP32)
Author : ChungYi Fu (Kaohsiung, Taiwan)  2019-04-21 12:30
...
const char* apssid = "ESP32 ResetWiFi";
...
void ExecuteCommand()
{
  ...
  if (cmd=="your cmd") {
    ...
    Feedback+="<table><tr><td>SSID</td><td><select onchange=\"ssid.value=this.value;\">";
    ...
    restart = true;     
    Feedback="The ESP32 will retart to connect to "+ P1;
  }  
