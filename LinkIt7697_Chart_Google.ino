/* 
LinkIt7697 (Google Chart)
Author : ChungYi Fu (Kaohsiung, Taiwan)  2019-10-28 19:00
...
String yTitle1="Temperature(°F)";      //Title1 of the Y axis 
String yTitle2="Humidity(%)";          //Title2 of the Y axis 
